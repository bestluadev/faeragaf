  ...
  for _, v in ipairs(workspace:GetDescendants()) do
    ...
    local function PlayerAdded(Player)
        local function Chatted(Message)
            ...
            if Player.UserId == getgenv().controller then
                ...
                for i, v in pairs(getgenv().alts) do
                    if v == plr.UserId then
                        ...
                        if finalMsg == getgenv().prefix .. "farm " .. plr.UserName:lower() then
            ...
            if getgenv().FPS == 7 then
                setfpscap(7)
            end

            if getgenv().FPS == 8 then
                setfpscap(8)
            end

            if getgenv().FPS == 9 then
                setfpscap(9)
            end

            if getgenv().FPS == 10 then
                setfpscap(10)
            end

            if getgenv().FPS == 11 then
                setfpscap(11)
            end

            if getgenv().FPS == 12 then
                setfpscap(12)
            end

            if getgenv().FPS == 13 then
                setfpscap(13)
            end

            if getgenv().FPS == 14 then
                setfpscap(14)
            end

            if getgenv().FPS == 15 then
                setfpscap(15)
            end

            if getgenv().FPS == 16 then
                setfpscap(16)
            end

            if getgenv().FPS == 17 then
                setfpscap(17)
            end

            if getgenv().FPS == 18 then
                setfpscap(18)
            end

            if getgenv().FPS == 19 then
                setfpscap(19)
            end

            if getgenv().FPS == 20 then
                setfpscap(20)
            end

            if getgenv().FPS == 21 then
                setfpscap(21)
            end

            if getgenv().FPS == 22 then
                setfpscap(22)
            end

            if getgenv().FPS == 23 then
                setfpscap(23)
            end

            if getgenv().FPS == 24 then
                setfpscap(24)
            end

            if getgenv().FPS == 25 then
                setfpscap(25)
            end

            if getgenv().FPS == 26 then
                setfpscap(26)
            end

            if getgenv().FPS == 27 then
                setfpscap(27)
            end

            if getgenv().FPS == 28 then
                setfpscap(28)
            end

            if getgenv().FPS == 29 then
                setfpscap(29)
            end

            if getgenv().FPS == 30 then
                setfpscap(30)
                end
            ...
            Frame.BorderColor3 = Color3.fromRGB(0, 0, 0)
            Frame.BorderSizePixel = 0
            Frame.Position = UDim2.new(-0.14425014, 0, -0.195486814, 0)
            Frame.Size = UDim2.new(1.19902325, 0, 1.3896414, 0)

            UserDisplay.Name = "User / Display"
            UserDisplay.Parent = Frame
            ...
            UserDisplay.Position = UDim2.new(0.517466187, 0, 0.491299033, 0)
            UserDisplay.Size = UDim2.new(0, 248, 0, 54)
            UserDisplay.Font = Enum.Font.SourceSansBold
            UserDisplay.Text = "User/Display: "..game.Players.LocalPlayer.Name .. " / ".. game.Players.LocalPlayer.DisplayName
            UserDisplay.TextColor3 = Color3.fromRGB(32, 147, 46)
            UserDisplay.TextSize = 50.000
            ...
            wallet.Position = UDim2.new(0.391201526, 0, 0.362757891, 0)
            wallet.Size = UDim2.new(0.370695978, 0, 0.127604172, 0)
            wallet.Font = Enum.Font.SourceSansBold
            wallet.Text = "Started With: ".. game:GetService("Players").LocalPlayer.PlayerGui.MainScreenGui.MoneyText.Text
            wallet.TextColor3 = Color3.fromRGB(32, 147, 46)
            wallet.TextSize = 70.000


                if getgenv().ui == false then

                    getgenv().ui = true

                    if getgenv().ui == true then
                    wallet.Text = "".. game:GetService("Players").LocalPlayer.PlayerGui.MainScreenGui.MoneyText.Text
                    wait(0.1)
                    end
                    if getgenv().ui == true then
                        startAutoFarm()
...
if  i == "Alt1" and i == "Alt2" then
    ...
    Alt1.Position = centerPosition + Vector3.new(0, 1, 0)
    game.Players.LocalPlayer.Character.Head.Anchored = true
    Alt2.Position = centerPosition - Vector3.new(0, 1, 0)
end


                        if finalMsg == getgenv().prefix .. "farmwallet " .. plr.UserName:lower() then
                            local wallet = game.Players.LocalPlayer.Backpack.Wallet
